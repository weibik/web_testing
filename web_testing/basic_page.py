...
class WebPage(Webdriver):
    ...
    def check_if_exists(self, locator: tuple):
        try:
    ...
    def check_if_visible(self, locator: tuple, timeout: int = 10):
        try:
    ...
    def wait_for_visibility(self, locator: tuple, timeout:int = 3):
